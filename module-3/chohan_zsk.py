...
while True:  # Main game loop.
    ...
    while True:
        pot = input('zsk: ') #Changed input prompt to initials and a colon
        if pot.upper() == 'QUIT':
    ...
    while True:
        bet = input('zsk: ').upper() #Changed input prompt to initials and a colon
    ...
    # Check for 2s and 7s
    if dice1+dice2 == 2:
        print('You rolled a 2, you get a 10 mon bonus!')
        purse = purse + 10
    if dice1+dice2 == 7:
        print('You rolled a 7, you get a 10 mon bonus!')
        purse = purse + 10
